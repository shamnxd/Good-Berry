...
function ShopHeader() {
    ...
    return (
        ...
        <div className="flex h-16 items-center px-4 lg:px-0 mx-auto !max-w-[1400px]">
          <Sheet>
              ...
              <div className="p-6 border-b flex flex-col gap-6">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-gray-50 border border-gray-100 rounded-lg py-2.5 pl-4 pr-10 text-sm focus:outline-none focus:ring-1 focus:ring-[#8CC63F] transition-all"
                    onKeyDown={(e) => {
                      if (e.key === "Enter") {
              ...
              <div className="flex-1 overflow-y-auto">
                <nav className="flex flex-col">
                  ...
                  <div className="mt-auto bg-gray-50/80">
                    ...
                    <Link to="/account?tab=Refer & Earn" className="px-6 py-4 text-base font-medium text-gray-800 hover:text-[#8CC63F] border-t border-gray-100 transition-colors flex items-center gap-3">
          ...
          <div className="flex items-center gap-1 md:me-4">
            ...
            {user ? <UserRound className="!h-6 !w-6 !fw-bold mx-2 text-black" /> : 'LOGIN/REGISTER'}
            </Link>
            <Button variant="transparent" size="icon" className="hidden md:flex" onClick={() => navigate('/search')}>
              <Search className="!h-6 !w-6 !fw-bold text-black" />
              <span className="sr-only">Search</span>
            </Button>
            {/* <Button variant="transparent" size="icon" className="hidden md:flex" onClick={() => navigate('/account')}>
              <Heart className="!h-6 !w-6 !fw-bold text-black" />
              <span className="sr-only">Wishlist</span>
            </Button> */}
            <Button variant="transparent" size="icon" className="relative" onClick={() => setIsCartOpen(true)}>
              <ShoppingCart className="!h-8 lg:!h-6 !w-8 lg:!w-6 text-black !fw-bold" />
